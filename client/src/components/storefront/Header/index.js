    ...
    <StyledHeader isNavOn={isNavOn}>
      <div className="header">
        <div className="header__logo">
          ...
          <img  src="https://st4.depositphotos.com/22052918/24702/v/600/depositphotos_247020524-stock-illustration-letters-simple-linked-logo-vector.jpg"  alt="Logo-image"/>
        ...
        <ul className="header__nav">
          <li>
            <NavLink to="/shop" className="shop1">Shop</NavLink>
          </li>
          {!username ? (
            <>
              <li>
